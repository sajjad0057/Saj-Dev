...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="/index.html">
                                ...
                                <span class="brand-name">SAJ-DEV Dashboard</span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2021 Copyright A TECH SOLUTION TEAM -
                <a class="text-primary" href="https://github.com/sajjad0057/" target="_blank">SAJ-DEV</a>.
            </p>
        </div>
    </div>
</body>
